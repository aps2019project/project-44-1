...
// TODO: 10/04/2019 if this class extends Controller i can not over load main why?
    ...
    public void enterBattle(AccountView view, AccountRequest request) {
    ...
    public void chooseGameMode(AccountView view, AccountRequest request, Account p1, Account p2, BattleKind battleKind) {
    ...
    public void chooseSecondPlayer(AccountView view, AccountRequest request, BattleKind battleKind) {
        while (true) {
            request.getNewCommand();
    ...
    public void chooseGameKind(AccountView view, AccountRequest request, BattleKind battleKind) {
        Account ai_player;
        while (true){
            request.getNewCommand();
