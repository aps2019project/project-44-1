...
public class ShopController {
    ...
    public void help(ShopView view) {

    }

    public void showShopCards(ShopView view) {

    }

    public void sell(ShopView view, ShopRequest request) {

    }

    public void buy(ShopView view, ShopRequest request) {

    }

    public void searchInCollection(ShopView view, ShopRequest request) {
        // not sure about this
    }

    public void searchInShop(ShopView view, ShopRequest request) {

    }

    public void showCollection(ShopView view) {
        // not sure about this
    }
}
